...
class APIClient {
	...
	constructor(action, next) {
		...
		// console.log(' >> APIClient: hostname: ' + hostname + ', port: ' + port);
		// console.log(' >> APIClient: resource: ' + resource);
		// console.log(' >> APIClient: namespace: ' + namespace);
...
//
//		console.log(' >> APIClient: WS URL: ' + this.wsurl);
//
...
//			this.namespace, 
//			function(data) {
//				// console.log(' >> APIClient: inbound message: ');
//				// console.log(data);
//			}
//		);
